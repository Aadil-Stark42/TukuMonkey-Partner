package com.tukumonkeypartner.route_map;
...
public class RouteDrawerTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
    ...
    protected void onPostExecute(List<List<HashMap<String, String>>> result) {
        if (result != null){
            Log.i("TESTROUTE","TESTROUTE"+result);
            drawPolyLine(result);
        }
    ...
    private void drawPolyLine(List<List<HashMap<String, String>>> result) {
        ...
        for (int i = 0; i < result.size(); i++) {
            ...
            Log.i("TESTROUTE","TESTROUTE"+"result"+lineOptions+mMap);
            // Fetching i-th route
            ...
            lineOptions.width(6);
            routeColor = ContextCompat.getColor(DrawRouteMaps.getContext(), R.color.teal_200);
            if (routeColor == 0)
                lineOptions.color(0xFF0A8F08);
            else
                lineOptions.color(routeColor);
        }
        Log.i("TESTROUTE","TESTROUTE"+"0"+lineOptions+mMap);
        // Drawing polyline in the Google Map for the i-th route
        if (lineOptions != null && mMap != null) {
            Log.i("TESTROUTE","TESTROUTE"+"1");
